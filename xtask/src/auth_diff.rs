...
//! column, taken by the same code on both sides in one run. Four rounds of
//! review on this module each published a digest of a harness they then
//! deleted; this one is recomputable from a checkout.
//!
