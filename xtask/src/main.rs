...
sha256 of the answer column taken by ONE binary over both sides and the axis
tally the RFC 9110 §11 review rounds are graded on. `head-rev` defaults to the
working tree. It works in $TMPDIR and leaves the repository untouched.
